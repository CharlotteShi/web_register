...
金币：<s:property value="money"/> <input type="button" value="充值"><br>
<a href="indexc.jsp?id_number=<s:property value="uid_number"/>"><input type="button" value="编辑"></a><br>
...
<a href="indexf.jsp"> <input type="button" value="挂号"></a>
</body>
</html>